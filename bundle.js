...
var config = {
  apiKey: "AIzaSyDS-aseRKx7Xc5Spl4fnRxapss8mTVJ34Q",
  authDomain: "spacepanda-ae988.firebaseapp.com",
  databaseURL: "https://spacepanda-ae988.firebaseio.com",
  projectId: "spacepanda-ae988",
  storageBucket: "spacepanda-ae988.appspot.com",
  messagingSenderId: "448554574137"
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _playerKeyboardInput__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./playerKeyboardInput */ "./src/playerKeyboardInput.js");
...
/* harmony import */ var _score_score__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../score/score */ "./score/score.js");
...
var currentUser = document.getElementById("highscore1"); // Creating a canvas //

var canvas = document.getElementById("gamescreen");
var ctx = canvas.getContext("2d"); // Creating a Score Board
...
playerOne.draw(ctx);
new _playerKeyboardInput__WEBPACK_IMPORTED_MODULE_0__["default"](playerOne); // Creating asteroids
...
var coinSound = document.getElementById("collectedcoin");
...
function gameLoop(timestamp) {
  ...
  var req = requestAnimationFrame(gameLoop);
}
  ...
  _createClass(Player, [{
    ...
    value: function draw(ctx) {
      if (this.keyLeft == 1 || this.keyDown == 1) {
        ctx.drawImage(this.images.left, this.position.x, this.position.y, this.width, this.height);
